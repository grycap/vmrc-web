...
<%@ page import="java.net.URL, 
	...
	org.grycap.vmrc.client.api.VMRCServerAPI,
						...
						<table style="border: 0; cellspacing: 0; background-image: url('img/i3m/f_cuadro_sup.gif'); 
							...
							<tr>
								...
								<td class="etiquetaCab" align="right">
									User:&nbsp;&nbsp; 
									<input name="userText" id="userText" type="text" size="15">&nbsp;&nbsp;&nbsp;&nbsp;
									Password:&nbsp;&nbsp; 
									<input name="passText" id="passText" type="password" size="20">&nbsp;&nbsp;&nbsp;&nbsp;
									VMRC Host:&nbsp;&nbsp; 
									<input name="hostText" id="hostText" type="text" size="30">&nbsp;&nbsp;&nbsp;&nbsp;
													...
													<tr class="titulo">
														<td>
															<a href="javascript:Siguiente('index.jsp?order=vmid')">
																<img src="img/i3m/flecha_up2.png" alt="OrdenaciÃ³n" border=0></a>
														    VM Id.
														</td>
														<td>
														...
														<img src="img/i3m/flecha_up2.png" alt="OrdenaciÃ³n" border=0>
